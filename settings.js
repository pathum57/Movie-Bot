...
SESSION_ID: process.env.SESSION_ID === undefined ? 'Movie-MD&dGlQGQ6K#V9rH8JxJmmyBapHowiBzTuH1xamXJYrVGS0Y1AB_ieo' : process.env.SESSION_ID,
...
RECORDING: process.env.RECORDING === undefined ? "𝚏𝚊𝚕𝚜𝚎" : process.env.RECORDING,
